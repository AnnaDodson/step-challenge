...
export class ScoreBoard extends Component {
  ...
  static renderScoreBoard (date, scores, displayLeaderBoard, showLeaderBoardStepCounts, error) {
  ...
  render () {
    ...
    this.state.loading
      ? <p><em>Loading...</em></p>
      : ScoreBoard.renderScoreBoard(this.state.dateOfLeaderboard, this.state.scores, this.state.showLeaderBoard, this.state.showLeaderBoardStepCounts, this.state.error);
